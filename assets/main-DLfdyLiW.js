(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(r){if(r.ep)return;r.ep=!0;const l=e(r);fetch(r.href,l)}})();const C=t=>({render:()=>`
  ...
  `,onRendered:()=>{t.forEach(s=>{var r;return(r=s.onRendered)==null?void 0:r.call(s)})}}},N=(t={},o={})=>{let e={...t};const s=Object.entries(o).filter(([,n])=>n).map(([n])=>n);return s.length>0&&s.forEach(n=>{const c=JSON.parse(localStorage.getItem(n)??null);c&&(e[n]=c)}),{getState:(n=null)=>n?e[n]:{...e},setState:n=>{const c={...e,...n},d=Object.keys(n).filter(i=>n[i]!==e[i]&&s.includes(i));e=c,d.length>0&&d.forEach(i=>{localStorage.setItem(i,JSON.stringify(n[i]))})},resetState:({clearStorage:n=!1}={})=>{e={...t},n&&s.forEach(c=>{localStorage.removeItem(c)})}}},H={user:null,isLoggedIn:!1},M={user:!0,isLoggedIn:!1},g=N(H,M),G=({username:t,email:o="",bio:e=""})=>{g.setState({user:{username:t,email:o,bio:e},isLoggedIn:!0})},q=()=>{g.resetState({clearStorage:!0})},V=({username:t,email:o="",bio:e=""})=>{g.setState({user:{username:t,email:o,bio:e}})},A=()=>({render:()=>`
  ...
  `,onRendered:()=>{var a,n;(a=o.onRendered)==null||a.call(o),(n=e.onRendered)==null||n.call(e)}}},D=()=>({render:()=>`
  ...
  `,onRendered:()=>{const e=document.querySelector("#login-form"),s=r=>{var a,n;r.preventDefault();const l=(a=e.querySelector("#username"))==null?void 0:a.value;(n=e.querySelector("#password"))==null||n.value,l&&(G({username:l}),b.navigate(u.HOME))};e.addEventListener("submit",s),y("loginPage",()=>{e.removeEventListener("submit",s)})}}),U=()=>({render:()=>`
    <main class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  `,onRendered:()=>{const e=document.querySelector("#home-link"),s=r=>{r.preventDefault(),b.navigate(u.HOME)};e.addEventListener("click",s),y("errorPage",()=>{e.removeEventListener("click",s)})}}),u={HOME:"/",PROFILE:"/profile",LOGIN:"/login",ERROR:"/error"},p={TAB:"TAB",PAGE:"PAGE"},P={[u.HOME]:{id:"home",type:p.TAB,container:()=>O(L),content:L,needAuth:!1},[u.PROFILE]:{id:"profile",type:p.TAB,container:()=>O(A),content:A,needAuth:!0},[u.LOGIN]:{id:"login",type:p.PAGE,container:D,needAuth:!1},[u.ERROR]:{id:"error",type:p.PAGE,container:U,needAuth:!1}},T="/front_5th_chapter1-1/",F=()=>{const t=a=>{const n=T+(a.startsWith("/")?a.slice(1):a);n!==window.location.pathname&&(window.history.pushState({},"",n),e())},o=(a,n)=>n.needAuth&&!g.getState("isLoggedIn")?{redirect:!0,path:u.LOGIN}:a===u.LOGIN&&g.getState("isLoggedIn")?{redirect:!0,path:u.HOME}:{redirect:!1},e=(a=!1)=>{var E,I,S;const c=(a?window.location.hash.slice(1):window.location.pathname).replace(T,"/"),d=P[c]??P[u.ERROR],i=o(c,d);if(i.redirect){t(i.path);return}const f=d.container();if(d.type===p.PAGE){x(),document.getElementById("root").innerHTML=f.render(),(E=f.onRendered)==null||E.call(f);return}const w=document.querySelector("#root #main");if(!w){x(),document.getElementById("root").innerHTML=f.render(),(I=f.onRendered)==null||I.call(f);return}const v=d.content();w.innerHTML=v.render(),(S=v.onRendered)==null||S.call(v)},s=()=>{e()},r=()=>{e(!0)};return{navigate:t,init:()=>{localStorage.getItem("user")&&g.setState({isLoggedIn:!0}),x(),window.addEventListener("popstate",s),window.addEventListener("hashchange",r),e()}}},b=F(),J=new URLSearchParams(window.location.search),$=J.get("p");$&&window.history.replaceState(null,"",$);b.init();
