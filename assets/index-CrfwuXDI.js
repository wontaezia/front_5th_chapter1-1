(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(r){if(r.ep)return;r.ep=!0;const l=e(r);fetch(r.href,l)}})();const T=t=>({render:()=>`
  ...
  `,onRendered:()=>{const e=document.querySelector("#login-form"),s=r=>{var a,n;r.preventDefault();const l=(a=e.querySelector("#username"))==null?void 0:a.value;(n=e.querySelector("#password"))==null||n.value,l&&(H({username:l}),b.navigate(m.HOME))};e.addEventListener("submit",s),E("loginPage",()=>{e.removeEventListener("submit",s)})}}),D=()=>({render:()=>`
    <main class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  `,onRendered:()=>{const e=document.querySelector("#home-link"),s=r=>{r.preventDefault(),b.navigate(m.HOME)};e.addEventListener("click",s),E("errorPage",()=>{e.removeEventListener("click",s)})}}),m={HOME:"/",PROFILE:"/profile",LOGIN:"/login",ERROR:"/error"},p={TAB:"TAB",PAGE:"PAGE"},P={[m.HOME]:{id:"home",type:p.TAB,container:()=>O(A),content:A,needAuth:!1},[m.PROFILE]:{id:"profile",type:p.TAB,container:()=>O(R),content:R,needAuth:!0},[m.LOGIN]:{id:"login",type:p.PAGE,container:j,needAuth:!1},[m.ERROR]:{id:"error",type:p.PAGE,container:D,needAuth:!1}},y="/front_5th_chapter1-1/",_=()=>{const t=a=>{const n=y+(a.startsWith("/")?a.slice(1):a);n!==window.location.pathname&&(window.history.pushState({},"",n),e())},o=(a,n)=>n.needAuth&&!g.getState("isLoggedIn")?{redirect:!0,path:m.LOGIN}:a===m.LOGIN&&g.getState("isLoggedIn")?{redirect:!0,path:m.HOME}:{redirect:!1},e=(a=!1)=>{var I,L,S;const c=(a?window.location.hash.slice(1):window.location.pathname).replace(y,"/"),d=P[c]??P[m.ERROR],i=o(c,d);if(i.redirect){t(i.path);return}const f=d.container();if(d.type===p.PAGE){x(),document.getElementById("root").innerHTML=f.render(),(I=f.onRendered)==null||I.call(f);return}const w=document.querySelector("#root #main");if(!w){x(),document.getElementById("root").innerHTML=f.render(),(L=f.onRendered)==null||L.call(f);return}const v=d.content();w.innerHTML=v.render(),(S=v.onRendered)==null||S.call(v)},s=()=>{e()},r=()=>{e(!0)};return{navigate:t,init:()=>{localStorage.getItem("user")&&g.setState({isLoggedIn:!0}),x(),window.addEventListener("popstate",s),window.addEventListener("hashchange",r),e()}}},b=_();b.init();
