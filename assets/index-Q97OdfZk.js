(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(r){if(r.ep)return;r.ep=!0;const l=e(r);fetch(r.href,l)}})();const T=t=>({render:()=>`
  ...
  `,onRendered:()=>{const e=document.querySelector("#home-link"),s=r=>{r.preventDefault(),b.navigate(m.HOME)};e.addEventListener("click",s),y("errorPage",()=>{e.removeEventListener("click",s)})}}),m={HOME:"/",PROFILE:"/profile",LOGIN:"/login",ERROR:"/error"},p={TAB:"TAB",PAGE:"PAGE"},O={[m.HOME]:{id:"home",type:p.TAB,container:()=>R(S),content:S,needAuth:!1},[m.PROFILE]:{id:"profile",type:p.TAB,container:()=>R(A),content:A,needAuth:!0},[m.LOGIN]:{id:"login",type:p.PAGE,container:j,needAuth:!1},[m.ERROR]:{id:"error",type:p.PAGE,container:D,needAuth:!1}},P="/front_5th_chapter1-1/",F=()=>{const t=a=>{const n=P+(a.startsWith("/")?a.slice(1):a);n!==window.location.pathname&&(window.history.pushState({},"",n),e())},o=(a,n)=>n.needAuth&&!g.getState("isLoggedIn")?{redirect:!0,path:m.LOGIN}:a===m.LOGIN&&g.getState("isLoggedIn")?{redirect:!0,path:m.HOME}:{redirect:!1},e=(a=!1)=>{var w,I,L;const c=(a?window.location.hash.slice(1):window.location.pathname).replace(P,"/"),d=O[c]??O[m.ERROR],i=o(c,d);if(i.redirect){t(i.path);return}const f=d.container();if(d.type===p.PAGE){x(),document.getElementById("root").innerHTML=f.render(),(w=f.onRendered)==null||w.call(f);return}const E=document.querySelector("#root #main");if(!E){x(),document.getElementById("root").innerHTML=f.render(),(I=f.onRendered)==null||I.call(f);return}const v=d.content();E.innerHTML=v.render(),(L=v.onRendered)==null||L.call(v)},s=()=>{e()},r=()=>{e(!0)};return{navigate:t,init:()=>{localStorage.getItem("user")&&g.setState({isLoggedIn:!0}),x(),window.addEventListener("popstate",s),window.addEventListener("hashchange",r),e()}}},b=F();b.init();
